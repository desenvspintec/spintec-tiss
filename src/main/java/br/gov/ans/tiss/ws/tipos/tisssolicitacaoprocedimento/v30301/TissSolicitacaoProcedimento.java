 ...
 * 
 */
@WebServiceClient(name = "tissSolicitacaoProcedimento", targetNamespace = "http://www.ans.gov.br/tiss/ws/tipos/tisssolicitacaoprocedimento/v30301", wsdlLocation = "http://webservicehml.unimedblumenau.com.br:8082/TISS30301OPS/tissSolicitacaoProcedimento?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TISSSOLICITACAOPROCEDIMENTO_QNAME = new QName("http://www.ans.gov.br/tiss/ws/tipos/tisssolicitacaoprocedimento/v30301", "tissSolicitacaoProcedimento");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://webservicehml.unimedblumenau.com.br:8082/TISS30301OPS/tissSolicitacaoProcedimento?wsdl");
    ...
    public TissSolicitacaoProcedimentoPortType getTissSolicitacaoProcedimentoPort() {
        return super.getPort(new QName("http://www.ans.gov.br/tiss/ws/tipos/tisssolicitacaoprocedimento/v30301", "tissSolicitacaoProcedimento_Port"), TissSolicitacaoProcedimentoPortType.class);
    }
    ...
    public TissSolicitacaoProcedimentoPortType getTissSolicitacaoProcedimentoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ans.gov.br/tiss/ws/tipos/tisssolicitacaoprocedimento/v30301", "tissSolicitacaoProcedimento_Port"), TissSolicitacaoProcedimentoPortType.class, features);
    }
